$(document).ready(function(){
  ...
  $(document).on('click', '.mobile', function(e){
    e.preventDefault;
    $(this).toggleClass('mobile__active');
    $('.portfolio__wrap').toggleClass('portfolio__active');
    $('.header__wrap').toggleClass('header__index');
  });

  $(document).on('click', '.portfolio__side a', function(e){
    e.preventDefault;
    $('.mobile__active').removeClass('mobile__active');
    $('.portfolio__active').removeClass('portfolio__active');
    $('.header__index').removeClass('header__index');
  });    
})
